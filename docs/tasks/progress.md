...
Трекер виконання атомарних задач. Відмічай `[x]` коли задача завершена.

Легенда: `[ ]` — todo, `[~]` — in progress, `[x]` — done, `[-]` — skipped/N/A.
...
### works-slider — `desktop/works-slider.md`
...
### specialists — `desktop/specialists.md`
...
- [ ] D-SPEC-07. Кнопка "УСЯ КОМАНДА →" — outlined, центрована

### services — `desktop/services.md`
...
### portfolio — `desktop/portfolio.md`
...
### testimonials — `desktop/testimonials.md`
...
- [ ] D-TEST-05. Сховати dots на десктопі
